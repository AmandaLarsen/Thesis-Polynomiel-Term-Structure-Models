...
###############################################################
# INITIAL MODEL: SIMULATION TRUE VS SWAPS
###############################################################
...
legend(
  ...
  cex = 1.25,
  xpd = NA,
  legend = c("Simulated observed", "Optimization 5"),
  col = cols,
  lty = 1,
  lwd = c(1.8, 1.6)
)
...
# save.image(file.path(getwd(), "ekf_workspace_tilfoej_a_med_andet_udvidet_int.RData"))
# load(file.path(getwd(), "ekf_workspace_tilfoej_a_med_andet_udvidet_int.RData"))
