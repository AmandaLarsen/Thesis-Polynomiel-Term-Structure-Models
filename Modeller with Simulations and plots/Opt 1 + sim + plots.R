...
run_simulation_study_current_model <- function(
  ...
  cat("\n=TRUE VS ESTIMATED PARAMETERS =n")
  print(true_vs_est)
...
legend(
  ...
  cex = 1.25,
  xpd = NA,
  legend = c("Simulated observed", "Optimization 1"),
  col = cols,
  lty = 1,
  lwd = c(1.8, 1.6)
)
...
# Optional:
# save.image("~/Desktop/ekf_workspace_correlated_model.RData")
load("~/Desktop/ekf_workspace_correlated_model.RData")
